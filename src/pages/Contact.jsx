      ...
      <div className="flex flex-col md:flex-row md:min-h-[calc(100vh-var(--header-height))]">
        ...
        <div className="md:w-1/2 flex flex-col md:justify-center" style={{ padding: '15px 15px 0 15px' }}>
          <div className="shadow-lg" style={{
            ...
            <h1 className="text-2xl md:text-4xl font-bold">{t('contact.title')}</h1>
            ...
            <p className="text-base md:text-lg mt-2">
              <span className="font-bold">{t('contact.phone.label')}</span>{' '}
              <a
                href="#"
            ...
            <p className="text-base md:text-lg mt-2"><span className="font-bold">{t('contact.location.label')}</span> {t('contact.location.value')}</p>
            <p className="text-base md:text-lg mt-2"><span className="font-bold">{t('contact.hours.label')}</span> {t('contact.hours.value')}</p>
            <div className="flex items-center mt-4" style={{ gap: '8px' }}>
              ...
              <span className="text-base md:text-lg">
                <span className="font-bold">{t('contact.social.label')}</span>{' '}
                <a
