      ...
      <div className="flex flex-col md:flex-row md:min-h-[calc(100vh-var(--header-height))]">
        ...
        <div className="md:w-1/2 flex flex-col md:justify-center" style={{ padding: '15px 15px 0 15px' }}>
          <div className="shadow-lg" style={{
            ...
            <h1 className="text-2xl md:text-4xl font-bold text-[#F5E6D3]">Contact Us</h1>
            <p className="text-base md:text-lg mt-4 text-[#F5E6D3]">
            ...
            <p className="text-base md:text-lg mt-2 text-[#F5E6D3]">
            ...
            <p className="text-base md:text-lg mt-2 text-[#F5E6D3]"><span className="font-bold">Location:</span> Houston Heights</p>
            <p className="text-base md:text-lg mt-2 text-[#F5E6D3]"><span className="font-bold">Hours:</span> By appointment</p>
            <div className="flex items-center mt-4" style={{ gap: '8px' }}>
              ...
              <span className="text-base md:text-lg text-[#F5E6D3]">
