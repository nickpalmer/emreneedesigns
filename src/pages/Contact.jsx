      ...
      <div className="flex items-center" style={{ minHeight: 'calc(100vh - 86px)' }}>
        ...
        <div className="flex flex-col justify-center flex-1" style={{ padding: '15px' }}>
          <div className="shadow-lg" style={{
            ...
            <p className="text-lg mt-4 text-[#F5E6D3]"><span className="font-bold">Email:</span> emily@mReneeDesigns.com</p>
            <p className="text-lg mt-2 text-[#F5E6D3]"><span className="font-bold">Phone:</span> (504) 383-5044</p>
            ...
            <div className="flex items-center mt-4">
              <a
                ...
                className="flex items-center text-lg text-[#F5E6D3] hover:text-[#286140] transition-colors"
              ...
              >
                ...
                <span className="font-bold">Follow us on Instagram</span> @mrenee_designs
              </a>
            </div>
          </div>
        </div>
